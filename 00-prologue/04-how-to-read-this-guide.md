...
7. **06-boundary-4** — Connector: toxic byte wrappers, enumeration/read traits, page validation, circuit breakers, in-memory and filesystem connectors, conformance harness (8 chapters)
