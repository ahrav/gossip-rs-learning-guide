...
**Struct declaration** (`finding.rs:186-196`):
```rust
...
**CanonicalBytes impl** (`finding.rs:198-212`):
```rust
...
**Field order invariant** (comment at `finding.rs:180-185`):
```
